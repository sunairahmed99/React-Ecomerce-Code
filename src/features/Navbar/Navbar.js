...
import { allcartdata} from '../Cart/cartSlice';
...
export default function Navbar({children}) {
  ...
  let {loginUser} = useSelector(Authdata)
   ...
   navigation = [
    ...
    { name: 'Cart', href: '/cart/page', current: false },
  ]
  ...
  if(loginUser && loginUser.role === 'admin'){
     ...
     navigation = [
      ...
      { name: 'Admin', href: '/admin/product/page', current: false },
      { name: 'Orders', href: '/admin/order/page', current: false },
    ]
  ...
  if(loginUser){
     ...
     userNavigation = [
      ...
      { name: 'My Orders', href: '/order/detail/page' },
      { name: 'My password', href: '/password/page' },
            ...
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden md:block">
                ...
                {loginUser && loginUser.role === 'user' && (
                    ...
                    <FaShoppingCart className="h-6 w-6 mr-7" aria-hidden="true"/>
              ...
              <div className="flex items-center px-5">
                ...
                {loginUser && loginUser.role === 'user' && (
                    ...
                    <div className='ml-4'>
                      ...
                      <FaShoppingCart className="h-6 w-7" aria-hidden="true"/>
                    </Link>
